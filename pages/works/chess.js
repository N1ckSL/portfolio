...
const Work = () => (
  <Layout title="Chess">
    <Container>
      ...
      <P>
      Good old Chess game, but instead of a wooden board, I&apos;m using  <Badge display="initial" colorScheme="blue">React</Badge> 😉. <br />
      </P>
      It is still in progess, so don&apos;t access it from mobile or small screens, for now 🙏
      <List ml={4} my={4}>
        <ListItem>
          <Meta>Website</Meta>
